...
const VideoDetail = () => {
  ...
  let { title, channelId, channelTitle } = "";
  ...
  if (videoDetail && videoDetail.statistics) {
    viewCount = videoDetail.statistics.viewCount;
    likeCount = videoDetail.statistics.likeCount;
  }

  // Filter out videos with empty snippet
  // const filteredVideos = videos?.filter((video) => video.snippet);
    ...
    <Box minHeight="95vh">
      <Stack direction={{ xs: "column", md: "row" }}>
        ...
        <Box px={2} py={{ md: 1, xs: 5 }} justifyContent="center" alignItems="center">
          ...
          {/* {filteredVideos && <Videos videos={filteredVideos} direction="column" />} */}
        </Box>
      </Stack>
    </Box>
  );
